...
with st.sidebar:
    ...
    if bottom_space < bottom_needed:
        st.warning("Slice may be too low for the full bottom cavity / center hole.")
    ...
    if st.session_state.generated and st.session_state.top_mesh is not None and st.session_state.bottom_mesh is not None:
        ...
        zip_bytes = make_zip_bytes(st.session_state.top_mesh, st.session_state.bottom_mesh, export_name)
